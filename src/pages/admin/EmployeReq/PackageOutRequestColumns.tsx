...
interface PackageOutColumnsProps {
    handleView: (pkg: PackageOutRequest) => void;
    handleEdit: (pkg: PackageOutRequest) => void;
    handleDelete: (pkgId: string) => void;
}

/**
 * PackageOutActions Component
 * Handles action buttons for a single package out request row
 */
const Actions = ({
    pkg,
    handleView,
...
/**
 * Package Out Columns Definition
 */
export const packageOutColumns = ({
    handleView,
    handleEdit,
    handleDelete,
}: PackageOutColumnsProps): Column<PackageOutRequest>[] => {
    return [
        {
            id: "employeeName",
            label: "Employee Name",
